...
$sql = "INSERT INTO requirement (title,category,author, content, description, ava, image, video, keyword, comment) 
...
<form  enctype="multipart/form-data"  method="post" role="form">
    ...
    <div class="form-group">
    <label> Video:</label>
    <input name="video" type="text"  placeholder="Nhập link nhúng video" class="form-control" >
    </div>   
    <br>
     <div class="form-group">
    <label> Keyword:</label>
