...
$sql = "UPDATE requirement SET title = '$title' ,category='$category',author='$author', content='$content', description='$description', ava='$ava', image='$image', video='$video', keyword='$keyword', comment='$comment' where id = '$id'  ";
$link -> query($sql);

echo '<script> location.href="req.php";</script>';
