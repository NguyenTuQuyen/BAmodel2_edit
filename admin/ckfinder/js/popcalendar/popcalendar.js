...
if( typeof( siteroot ) == 'undefined' ) var siteroot = '/';
...
var popCalendar = {
  ...
  init: function(installEventHandlers) {
    ...
    with (c) { type = 'text/css'; rel = 'stylesheet'; href = siteroot + 'js/popcalendar/calendar_themes/' + this.theme+'/style.css'; media = 'screen'; }
